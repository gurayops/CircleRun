...
"""
Borular eklenecek.
- Once en sagdan baslayacak sonra kayarak devam edecek.
- Pipe'lar arasindaki bosluk aradan gececek cismin 3.5 kati kadar.
- Oyunun core challange'i bu.
- Her update icinde pipe'lar 2px kayacak.
- En sola giden pipe'lar ekrandan kaybolunca silinecek.
- Her 1.5 saniyede 1 yeni pipe gelecek.
Bunu verecek sekilde pipelari yerlestirecegiz. Biraz randomluk da lazim.
"""
